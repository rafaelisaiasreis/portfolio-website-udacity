...
Basically, it consists of developing a responsive site from a design mockup received by Udacity
The web page was created using `HTML`,` CSS`, `JavaScript` and` bootstrap v3.3.7`.

## How do I run this?

Download and run the `index.html` file located inside the` full_stack_project2.` folder
To run files with `.html` extension, it's necessary to have an Internet Browser installed. If you don't have a web browser installed on your device, choose one of your preference (`Safari, Chrome, Mozilla Firefox` etc.) and install it.
